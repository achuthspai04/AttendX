...
class Ui_MainWindow(object):
    def run_main(self):
        subprocess.call([sys.executable, r'D:/new/AttendX/main.py'])
    ...
    def setupUi(self, MainWindow):
        ...
        self.label = QLabel(self.centralwidget)  # Add this line
        self.label.setObjectName("label")
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout()  # Add this line
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")  # Add this line
        self.horizontalLayout_4.addWidget(self.label)  # Add this line
